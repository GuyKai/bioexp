...
def checkgesture():
    ...
    global moveDown
    while True:
        if LIST[-1] == 7 and LIST[-2] == 7 :
            moveRight = False
            moveLeft = True
            time.sleep(0.5)
            moveLeft = False
            time.sleep(0.5)
        elif LIST[-1] == 6 and LIST[-2] == 6 :
            moveLeft = False
            moveRight = True
            time.sleep(0.5)
            moveRight = False
            time.sleep(0.5)
        elif LIST[-1] == 4 and LIST[-2] == 4 :
            moveDown = False
            moveUp = True
            time.sleep(0.5)
            moveUp = False
            time.sleep(0.5)
        elif LIST[-1] == 5 and LIST[-2] == 5 :
            moveUp = False
            moveDown = True
            time.sleep(0.5)
            moveDown = False
            time.sleep(0.5)
        elif LIST[-1] == 0 and LIST[-2] == 0 :
            moveLeft = False
            moveRight = False
            moveUp = False
            moveDown = False
...
RF = threading.Event()
model_thread = threading.Thread(target = model.main, args=(RF, COM_PORT, BAUD_RATES, LIST,))
...
checker = threading.Thread(target = checkgesture)
checker.start()
while (count>0):
    # start of the game
    baddies = []
